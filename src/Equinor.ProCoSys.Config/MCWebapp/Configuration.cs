...
{
    public static class MCWebAppConfiguration
    {
        [Authorize]
        [FunctionName("MCWebAppConfiguration")]
        public static IActionResult Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "MCWebApp/Configuration")] HttpRequest req,
            ILogger log)
        {
            ...
            var configConnectionString = Environment.GetEnvironmentVariable("MCWebAppConfig");
